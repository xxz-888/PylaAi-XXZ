...
class Hub:
    ...
    def __init__(self,
        ...
        self.bot_config.setdefault("teammate_lock_lost_grace", 0.35)
        self.bot_config.setdefault("teammate_follow_step_distance", 8)
        self.bot_config.setdefault("teammate_follow_prediction_seconds", 0.35)
        self.bot_config.setdefault("teammate_follow_max_lead", 90)
        self.bot_config.setdefault("teammate_combat_bias", 0.88)
        ...
        self.bot_config.setdefault("teammate_marker_fallback_delay", 0.25)
